...
// ApplicationV2 ApplicationV2 - the contents of an application
...
// Validate validates this application v2
func (m *ApplicationV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationV2) validateAppManifest(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateDataIfcEndpoints(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateEdgeSelectors(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateName(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateOriginSelectors(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateProjectID(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateTenantID(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *ApplicationV2) validateHelmMetadata(formats strfmt.Registry) error {
...
func (m *ApplicationV2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ApplicationV2) UnmarshalBinary(b []byte) error {
	var res ApplicationV2
