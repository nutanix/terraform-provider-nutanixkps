...
// SoftwareReleaseListPayload SoftwareReleaseListPayload is the payload for batch list REST response
// swagger:model SoftwareReleaseListPayload
...
// Validate validates this software release list payload
func (m *SoftwareReleaseListPayload) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SoftwareReleaseListPayload) validatePageIndex(formats strfmt.Registry) error {
...
func (m *SoftwareReleaseListPayload) validatePageSize(formats strfmt.Registry) error {
...
func (m *SoftwareReleaseListPayload) validateReleaseList(formats strfmt.Registry) error {

	if err := validate.Required("result", "body", m.ReleaseList); err != nil {
		return err
	}
...
func (m *SoftwareReleaseListPayload) validateTotalCount(formats strfmt.Registry) error {
...
func (m *SoftwareReleaseListPayload) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SoftwareReleaseListPayload) UnmarshalBinary(b []byte) error {
	var res SoftwareReleaseListPayload
