...
// UserListPayload payload for UserListResponseV2
// swagger:model UserListPayload
...
// Validate validates this user list payload
func (m *UserListPayload) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UserListPayload) validatePageIndex(formats strfmt.Registry) error {
...
func (m *UserListPayload) validatePageSize(formats strfmt.Registry) error {
...
func (m *UserListPayload) validateTotalCount(formats strfmt.Registry) error {
...
func (m *UserListPayload) validateUserList(formats strfmt.Registry) error {

	if err := validate.Required("result", "body", m.UserList); err != nil {
		return err
	}
...
func (m *UserListPayload) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UserListPayload) UnmarshalBinary(b []byte) error {
	var res UserListPayload
