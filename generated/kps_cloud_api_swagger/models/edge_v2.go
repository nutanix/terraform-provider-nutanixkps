...
// EdgeV2 Edge is the DB object and object model for edge
//
...
// Validate validates this edge v2
func (m *EdgeV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EdgeV2) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateEdgeDevices(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateGateway(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateIPAddress(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateLabels(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateName(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateSerialNumber(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateSubnet(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateTenantID(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *EdgeV2) validateRole(formats strfmt.Registry) error {
...
func (m *EdgeV2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EdgeV2) UnmarshalBinary(b []byte) error {
	var res EdgeV2
