...
// WithFilter adds the filter to the edge upgrade list params
func (o *EdgeUpgradeListParams) WithFilter(filter *string) *EdgeUpgradeListParams {
	o.SetFilter(filter)
	return o
}

// SetFilter adds the filter to the edge upgrade list params
func (o *EdgeUpgradeListParams) SetFilter(filter *string) {
	o.Filter = filter
}

// WithOrderBy adds the orderBy to the edge upgrade list params
func (o *EdgeUpgradeListParams) WithOrderBy(orderBy []string) *EdgeUpgradeListParams {
	o.SetOrderBy(orderBy)
	return o
}

// SetOrderBy adds the orderBy to the edge upgrade list params
func (o *EdgeUpgradeListParams) SetOrderBy(orderBy []string) {
	o.OrderBy = orderBy
}
