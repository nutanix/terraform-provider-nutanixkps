...
func (o *ApplicationDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/application/{id}][%d] applicationDeleteOK  %+v", 200, o.Payload)
}

func (o *ApplicationDeleteOK) GetPayload() *models.DeleteDocumentResponse {
	return o.Payload
}
...
func (o *ApplicationDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/application/{id}][%d] ApplicationDelete default  %+v", o._statusCode, o.Payload)
}

func (o *ApplicationDeleteDefault) GetPayload() *models.APIErrorPayload {
	return o.Payload
}
