...
// WithAuthorization adds the authorization to the get config params
func (o *GetConfigParams) WithAuthorization(authorization string) *GetConfigParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get config params
func (o *GetConfigParams) SetAuthorization(authorization string) {
	o.Authorization = authorization
}

// WithServiceDomain adds the serviceDomain to the get config params
func (o *GetConfigParams) WithServiceDomain(serviceDomain string) *GetConfigParams {
	o.SetServiceDomain(serviceDomain)
	return o
}

// SetServiceDomain adds the serviceDomain to the get config params
func (o *GetConfigParams) SetServiceDomain(serviceDomain string) {
