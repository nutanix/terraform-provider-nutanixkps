...
// WithAuthorization adds the authorization to the get status params
func (o *GetStatusParams) WithAuthorization(authorization string) *GetStatusParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the get status params
func (o *GetStatusParams) SetAuthorization(authorization string) {
	o.Authorization = authorization
}

// WithServiceDomain adds the serviceDomain to the get status params
func (o *GetStatusParams) WithServiceDomain(serviceDomain string) *GetStatusParams {
	o.SetServiceDomain(serviceDomain)
	return o
}

// SetServiceDomain adds the serviceDomain to the get status params
func (o *GetStatusParams) SetServiceDomain(serviceDomain string) {
