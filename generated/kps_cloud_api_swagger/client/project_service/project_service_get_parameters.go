...
// WithAuthorization adds the authorization to the project service get params
func (o *ProjectServiceGetParams) WithAuthorization(authorization string) *ProjectServiceGetParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the project service get params
func (o *ProjectServiceGetParams) SetAuthorization(authorization string) {
