...
type IsEmailAvailableOK struct {
	Payload *models.EmailAvailability
}

func (o *IsEmailAvailableOK) Error() string {
	return fmt.Sprintf("[GET /v1.0/isemailavailable][%d] isEmailAvailableOK  %+v", 200, o.Payload)
}

func (o *IsEmailAvailableOK) GetPayload() *models.EmailAvailability {
	return o.Payload
}
...
func (o *IsEmailAvailableOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.EmailAvailability)
...
func (o *IsEmailAvailableDefault) Error() string {
	return fmt.Sprintf("[GET /v1.0/isemailavailable][%d] IsEmailAvailable default  %+v", o._statusCode, o.Payload)
}

func (o *IsEmailAvailableDefault) GetPayload() *models.APIErrorPayload {
	return o.Payload
}
